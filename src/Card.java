 ...
 * (1) week_5.Card object representation
 * (2) String representation
 * (3) single integer representation (0 - 51)
 * (4) two integer (rank, suit) representation
 *
 * _Avoid the construction of new week_5.Card objects._  Use the week_5.Card objects already created in allCards, retrieving them via
 * (1) static HashMap&lt;String, week_5.Card%gt; strCardMap using the method get(String),
 * (2) static week_5.Card getCard(int), or
 * (3) static week_5.Card getCard(int rank, int suit).
 *
...
public class Card {
	...
	/**
	 * an array of all unique week_5.Card objects
	 */
	...
	/**
	 * map from String representations to week_5.Card objects
	 */
	public static HashMap<String, Card> strCardMap = new HashMap<String, Card>();

	/**
	 * map from String representations to week_5.Card id numbers
	 */
	public static HashMap<String, Integer> strIdMap = new HashMap<String, Integer>();

	/**
	 * map from week_5.Card id numbers to String representations
	 */
	...
	/**
	 * Get the week_5.Card object corresponding to the given week_5.Card id number (0 - 51)
	 * @param id week_5.Card id number (0 - 51)
	...
	/**
	 * Get the week_5.Card object corresponding to the given rank and suit indices
	...
	/**
	 * Get the week_5.Card id number corresponding to the given rank and suit indices
	 * @param rank rank index
	 * @param suit suit index
	 * @return corresponding week_5.Card id number
	 */
	 ...
	 * AVOID USE IF POSSIBLE.  Use the week_5.Card objects already created in allCards, retrieving them via
	 * (1) static HashMap&lt;String, week_5.Card&gt; strCardMap using the method get(String),
	 * (2) static week_5.Card getCard(int), or
	 * (3) static week_5.Card getCard(int rank, int suit).
	...
	/**
	 * Return the week_5.Card id number.
	 * @return the week_5.Card id number
	 */
	public int getId() {
		return suit * NUM_RANKS + rank;
